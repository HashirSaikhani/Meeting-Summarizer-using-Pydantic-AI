...
extract_feature_agent = Agent(
    ...
    system_prompt = """
        You are an assistant that extracts key features (main features - implementation wise) from meeting transcripts.

        Instructions:
        - Focus only on essential, meaningful features (the "big picture") (implementation wise).
        ...
        - Use a clear structured hierarchy:
            ...
            2) Next Main Feature
               - Sub-feature (optional)
        - Do NOT use parentheses or inline lists. Each sub-feature must be a separate bullet under its main feature.
